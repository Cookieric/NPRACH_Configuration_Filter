...
MAC_COMMAND="--rachperiod ${1} --rachstart ${6} --rachrepeat ${2} --rachscofst 0 --rachnumsc 2 --rmax ${3} --gvalue ${4} --candidate ${7} --dlcqi 7 --rawindow ${9} --rartbsindex 3 --rarsfindex 1 --dlrepeat 0 --s2tbs 2" #case1
